...
class Home_Test_Modele_Index extends Core_Modele_Abstract {
    ...
    public function getContent() {
        ...
        $client->setRedirectUri(Home_Test_Controller_Index::getUrl("index", "result", array(), true));
    ...
    public function authenticate($code) {
        ...
        Core_Session::getInstance()->setData(Home_Test_Modele_Index::ACCESS_TOKEN, $accessToken);
